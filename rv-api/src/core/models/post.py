...
def upload_post_img(instance, arquivo):
    return f"media/users/{id}/{arquivo}"
...
class Post(models.Model):
    ...
    img = models.ImageField(upload_to=upload_post_img, height_field=None, width_field=None, max_length=None)
